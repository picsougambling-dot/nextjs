...
export const pathnames: Record<string, Record<string, string>> = {
  ...
  '/bonus-sans-depot': {
    en: '/no-deposit-bonus',
    fr: '/bonus-sans-depot',
    es: '/bonus-sin-deposito',
    de: '/bonus-ohne-einzahlung',
    ru: '/bonus-bez-depozita',
    it: '/bonus-senza-deposito',
    br: '/bonus-sem-deposito',
    pt: '/bonus-sem-deposito',
    nl: '/bonus-zonder-storting',
    lv: '/bonuss-bez-depozita',
    fi: '/talletusvapaa-bonus',
  },
  '/top-slots-2026': {
    en: '/top-slots-2026',
    fr: '/top-slots-2026',
    es: '/mejores-slots-2026',
    de: '/top-slots-2026',
    ru: '/top-sloty-2026',
    it: '/migliori-slot-2026',
    br: '/melhores-slots-2026',
    pt: '/melhores-slots-2026',
    nl: '/top-slots-2026',
    lv: '/top-sloti-2026',
    fi: '/parhaat-slotit-2026',
  },
