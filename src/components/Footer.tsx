...
const Footer = () => {
  ...
  const footerCasinos = useMemo(() => {
    const casinoNames = ["SpinStar", "Kings Chance", "HunnyPlay", "Lucky Treasure", "Rockstar", "Lucky Trunk", "SpinDinasty", "SpinAura", "Wild Dice", "AmonBet", "SlotLair"];
    return casinos
      .filter((casino) => {
  ...
  const footerReviews = useMemo(() => {
    const reviewCasinos = [
      { name: "RoiBets", path: "/blog/avis-roibets-2026", translationKey: "roibets" },
      { name: "Rockstar", path: "/blog/avis-rockstar-2026", translationKey: "rockstar" },
      { name: "i24Slots", path: "/blog/avis-i24slots-2026", translationKey: "i24slots" },
      { name: "EuropeFortune", path: "/blog/avis-europefortune-2026", translationKey: "europefortune" }
    ];
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-7 gap-4 sm:gap-6">
          ...
          <div>
            ...
            <ul className="space-y-1">
              ...
              <li><Link href="/bonus-sans-depot" className="text-xs text-muted-foreground hover:text-primary transition-colors duration-200">{t('links.guides.noDeposit')}</Link></li>
              <li><Link href="/bonus-sans-wager" className="text-xs text-muted-foreground hover:text-primary transition-colors duration-200">{t('links.guides.noWager')}</Link></li>
              ...
              <li><Link href="/top-slots-2026" className="text-xs text-muted-foreground hover:text-primary transition-colors duration-200">{t('links.guides.topSlots')}</Link></li>
            </ul>
          </div>

          {/* Guide Complet */}
          <div>
            <h3 className="font-semibold text-sm mb-2 text-primary">📚 Guide Complet</h3>
            <ul className="space-y-1">
              <li><Link href="/blog/guide-bonus-casino-2026" className="text-xs text-muted-foreground hover:text-primary transition-colors duration-200">Guide Bonus Casino 2026</Link></li>
            </ul>
          </div>
