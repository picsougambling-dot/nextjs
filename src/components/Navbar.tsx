    ...
    <nav className="fixed top-0 left-0 right-0 z-50 glass-card-overlay border-b border-border">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          <Link href={getLocalizedHref("/")} className="flex items-center gap-2 group flex-shrink-0 mr-4">
            <Image 
              src="/gigabonus-logo.webp" 
              alt="GigaBonus Logo" 
              className="object-contain transition-transform duration-300 group-hover:scale-105 flex-shrink-0"
              width={150}
              height={100}
              priority
              style={{ height: '100px', width: 'auto', maxHeight: '100px', minHeight: '100px', minWidth: '120px' }}
            />
          </Link>
                  ...
                  <nav className="flex flex-col gap-4 mt-6">
                    ...
                    <Collapsible>
                      ...
                      <CollapsibleContent className="grid grid-cols-3 gap-3 mt-2 p-2">
                        {filteredCasinos.filter(casino => {
                          ...
                          const casinoHref = `/${casino.name.toLowerCase().replace(/\s+/g, '').replace(/\./g, '')}`;
                          return (
                            <Link 
                              key={casino.id}
                    ...
                    <Collapsible>
                      ...
                      <CollapsibleContent className="flex flex-col gap-2 mt-2 pl-4">
                        ...
                        <Link href={getLocalizedHref("/bonus-sans-depot")} onClick={() => setMobileMenuOpen(false)} className="text-sm hover:text-primary">{t('bonusNoDeposit')}</Link>
                      </CollapsibleContent>
                    </Collapsible>
                    ...
                    <Collapsible>
                      ...
                      <CollapsibleContent className="flex flex-col gap-2 mt-2 pl-4">
                        ...
                        <Link href={getLocalizedHref("/top-slots-2026")} onClick={() => setMobileMenuOpen(false)} className="text-sm hover:text-primary">{t('topSlots2026')}</Link>
                  ...
                  <NavigationMenuContent>
                    <ul className="grid w-[700px] gap-3 p-4 md:grid-cols-4 bg-background">
                      {filteredCasinos.map((casino) => (
                        <LogoListItem 
                          key={casino.id}
                          href={getLocalizedHref(`/${casino.name.toLowerCase().replace(/\s+/g, '').replace(/\./g, '')}`)} 
                          logo={casino.logo}
                          name={casino.name}
                        />
                      ))}
                ...
                <NavigationMenuItem>
                  ...
                  <NavigationMenuContent>
                    <ul className="grid w-[400px] gap-3 p-4 bg-background">
                      ...
                      <ListItem href={getLocalizedHref("/bonus-sans-depot")} title={t('bonusNoDeposit')} />
                    </ul>
                  </NavigationMenuContent>
                </NavigationMenuItem>
                ...
                <NavigationMenuItem>
                  ...
                  <NavigationMenuContent>
                    <ul className="grid w-[400px] gap-3 p-4 bg-background">
                      ...
                      <ListItem href={getLocalizedHref("/top-slots-2026")} title={t('topSlots2026')} />
