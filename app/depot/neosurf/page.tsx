...
export default function DepotNeosurfPage() {
  ...
  }, [neosurfCasinos, searchTerm, bonusFilter, wagerFilter]);
          ...
          <section className="glass-card rounded-2xl p-8 mb-12 max-w-5xl mx-auto">
            <div className="space-y-4 text-foreground text-center">
              <p className="text-lg leading-relaxed">
                ...
                Sur <strong className="text-primary">GigaBonus.fr</strong>, découvrez notre sélection exclusive de <strong className="text-primary">casinos acceptant Neosurf</strong> avec des bonus attractifs et des conditions de mise transparentes.
              </p>
              <p className="text-lg leading-relaxed">
