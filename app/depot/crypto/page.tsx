          ...
          <section className="glass-card rounded-2xl p-8 mb-12 max-w-5xl mx-auto">
            <div className="space-y-4 text-foreground text-center">
              <p className="text-lg leading-relaxed">
                ...
                Sur <strong className="text-primary">GigaBonus.fr</strong>, découvrez notre sélection exclusive de plateformes acceptant <strong className="text-primary">Bitcoin (BTC)</strong>, <strong className="text-primary">Ethereum (ETH)</strong>, <strong className="text-primary">Litecoin (LTC)</strong>, <strong className="text-primary">Tether (USDT)</strong> et bien d'autres cryptomonnaies.
              </p>
              <p className="text-lg leading-relaxed">
