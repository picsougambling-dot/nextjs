...
export default function DepotSkrillPage() {
  ...
  }, [skrillCasinos, searchTerm, bonusFilter, wagerFilter]);
          ...
          <section className="glass-card rounded-2xl p-8 mb-12 max-w-5xl mx-auto">
            <div className="space-y-4 text-foreground text-center">
              <p className="text-lg leading-relaxed">
                ...
                Sur <strong className="text-primary">GigaBonus.fr</strong>, découvrez notre sélection de <strong className="text-primary">casinos acceptant Skrill</strong> avec des bonus exclusifs et des conditions optimales.
              </p>
              <p className="text-lg leading-relaxed">
