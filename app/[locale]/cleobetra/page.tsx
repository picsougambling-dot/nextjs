...
export default function CleobetraPage() {
  ...
  const schemaData = {
    ...
    "@graph": [
      ...
      {
        "@type": "Article",
        "headline": "Cleobetra Casino : Avis 2026, Bonus 150% + 200 FS",
        "description": "Avis Cleobetra Casino 2026 : bonus 150% jusqu'à 500€ + 200 FS, casino et paris sportifs, cashback 10% sans wager. Test complet!",
        "author": {
          "@type": "Person",
          "name": "Alexandre Martin"
        },
  ...
  return (
    <>
      <SEOHead
        title="Cleobetra Casino : Avis 2026, Bonus 150% + 200 FS | GigaBonus"
        description="Avis Cleobetra Casino 2026 : bonus 150% jusqu'à 500€ + 200 FS, casino et paris sportifs, cashback 10% sans wager. Test complet!"
        ...
        ogTitle="Cleobetra Casino : Avis 2026, Bonus 150% + 200 FS"
        ogDescription="Avis Cleobetra Casino 2026 : bonus 150% jusqu'à 500€ + 200 FS, casino et paris sportifs."
        ogImage="https://gigabonus.win/images/cleobetra.webp"
        twitterTitle="Cleobetra Casino : Avis 2026, Bonus 150% + 200 FS"
        twitterDescription="Avis Cleobetra Casino 2026 : bonus 150% jusqu'à 500€ + 200 FS."
        schema={schemaData}
      />
      <Navbar />
      <Breadcrumbs />
      <div className="min-h-screen pt-28 pb-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <section className="glass-card rounded-3xl overflow-hidden mb-12">
            ...
            <div className="p-8 md:p-12">
              <h1 className="text-3xl md:text-4xl font-bold text-center text-foreground mb-8">
                Avis Cleobetra Casino 2026 : Bonus 150% + 200 FS - Notre Test Complet
              </h1>
          ...
          <section className="glass-card rounded-2xl p-8 mb-12 bg-primary/5 border-2 border-primary/20">
            <h2 className="text-3xl font-bold text-center text-foreground mb-6">📋 Notre Avis Cleobetra : Le Verdict de GigaBonus 2026</h2>
            <div className="space-y-6 text-foreground max-w-4xl mx-auto">
