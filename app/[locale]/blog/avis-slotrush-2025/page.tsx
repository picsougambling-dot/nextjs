...
const schemaData = {
    ...
    "@graph": [
      ...
      {
        "@type": "Article",
        "headline": "Avis SlotRush Casino 2026 : Test Complet - Bonus 350% + Bookmaker",
        "author": {
          "@type": "Person",
          "name": "Alexandre Martin",
          "jobTitle": "Expert Casino Senior"
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <header className="text-center mb-12">
            ...
            <h1 className="text-4xl font-bold mb-4">
              <span className="text-primary">Avis SlotRush Casino 2026</span>
            </h1>
          ...
          <article className="glass-card rounded-2xl p-8 mb-8">
            ...
            <div className="space-y-4 text-muted-foreground">
              <p>
                ...
                en fait l'une des offres les plus généreuses de 2026. Avec un <strong className="text-foreground">wager de x40</strong>, les 
