...
export default function AvisPlayRegal() {
  ...
  const tBlog = useTranslations('BlogPages.avis-playregal-2025');
...
const jsonLd = {
  ...
  return (
    <>
      <SEOHead
        locale={locale}
        title="Avis Play Regal 2026 : Test Complet & Bonus | GigaBonus"
        description="Découvrez notre avis détaillé sur Play Regal Casino en 2026. Test complet : bonus 100% jusqu'à 1000€, wager x30, retraits rapides."
        keywords="avis play regal, play regal casino, bonus play regal, avis play regal 2026, casino play regal"
        canonical={`https://gigabonus.win/${locale}/blog/avis-playregal-2026`}
        ogTitle="Avis Play Regal 2026 : Test Complet & Bonus"
        ogDescription="Découvrez notre avis détaillé sur Play Regal Casino en 2026. Test complet : bonus 100% jusqu'à 1000€."
        ogImage="https://gigabonus.win/images/playregal.webp"
        twitterTitle="Avis Play Regal 2026 : Test Complet & Bonus"
        twitterDescription="Découvrez notre avis détaillé sur Play Regal Casino en 2026. Test complet : bonus 100% jusqu'à 1000€."
        schema={jsonLd}
      />
      <Navbar />
          ...
          <article>
            <header className="mb-8">
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-4 text-foreground">
                Avis Play Regal Casino 2026 : Test Complet
              </h1>
              <div className="flex items-center gap-4 text-muted-foreground text-sm">
                <time dateTime="2026-10-11">11 octobre 2026</time>
                <span>•</span>
