...
if (!casino) {
  ...
  "@graph": [
    ...
    {
      "@type": "Article",
      "headline": "Avis I24Slots 2026 : Bonus VIP et Programme de Fidélité | GigaBonus",
      ...
      "image": "https://gigabonus.win/images/i24slots.webp",
      "datePublished": "2026-11-21T10:00:00+01:00",
      "dateModified": "2026-11-28T00:45:35.341Z",
      "author": {
        "@type": "Person",
        "name": "Alexandre Martin"
      },
          ...
          <header className="text-center mb-12">
            <div className="flex justify-center mb-6">
              <img 
                ...
                alt="I24Slots Casino Logo - Avis et Test Complet 2026 avec bonus 100% + 150 FS" 
                width="200"
                height="96"
                loading="eager"
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-4">
              <span className="text-primary">Avis Complet I24Slots 2026</span>
            </h1>
