...
const jsonLd = {
  ...
  return (
    <>
      <SEOHead
        locale={locale}
        title="Avis Unique Casino 2026 : Test Complet & Bonus | GigaBonus"
        description="Découvrez notre avis détaillé sur Unique Casino en 2026. Test complet : bonus 200% jusqu'à 500€ + 100 free spins, wager x50, retraits rapides."
        keywords="avis unique casino, unique casino, bonus unique casino, avis unique casino 2026, casino unique"
        canonical={`https://gigabonus.win/${locale}/blog/avis-uniquecasino-2026`}
        ogTitle="Avis Unique Casino 2026 : Test Complet & Bonus"
        ogDescription="Découvrez notre avis détaillé sur Unique Casino en 2026. Test complet : bonus 200% jusqu'à 500€ + 100 free spins."
        ogImage="https://gigabonus.win/images/uniquecasino.webp"
        twitterTitle="Avis Unique Casino 2026 : Test Complet & Bonus"
        twitterDescription="Découvrez notre avis détaillé sur Unique Casino en 2026. Test complet : bonus 200% jusqu'à 500€ + 100 free spins."
        schema={jsonLd}
      />
      <Navbar />
          ...
          <article>
            <header className="mb-8">
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-4 text-foreground">
                Avis Unique Casino 2026 : Test Complet
              </h1>
              <div className="flex items-center gap-4 text-muted-foreground text-sm">
                <time dateTime="2026-10-14">14 octobre 2026</time>
                <span>•</span>
