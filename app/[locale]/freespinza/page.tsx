...
export default function FreeSpinzaPage() {
  ...
  return (
    <>
      <SEOHead
        title={`Avis FreeSpinza 2025 : Bonus ${casino.bonusText} | Notre Test Complet`}
        description={`Notre avis complet sur FreeSpinza 2025 : bonus ${casino.bonusText}, ${casino.wager === null ? 'sans wager' : `wager x${casino.wager}`}, bookmaker intégré, retraits rapides. Test détaillé !`}
        ...
        ogTitle={`Avis FreeSpinza 2025 : Bonus ${casino.bonusText}`}
        ...
        twitterTitle={`Avis FreeSpinza 2025 : Bonus ${casino.bonusText}`}
