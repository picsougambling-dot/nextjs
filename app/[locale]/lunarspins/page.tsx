...
export default function LunarSpinsPage() {
  const videoRef = useRef<HTMLVideoElement>(null);
  const tCommon = useTranslations('Common');
  const locale = useLocale();
  const t = useTranslations('CasinoPages.lunarspins');
  const casino = casinos.find(c => c.name === "LunarSpins")!;
    ...
    "@graph": [
      {
        ...
        "itemReviewed": {
          "@type": "Product",
          "name": "LunarSpins",
          "image": "https://gigabonus.win/images/lunarspins.webp"
        },
        "author": {
          "@type": "Person",
        ...
        "reviewBody": `LunarSpins propose un bonus de ${casino.bonusText} avec ${casino.wager === null ? 'sans conditions de mise' : `wager x${casino.wager}`}. Plateforme complète avec bookmaker intégré et catalogue de jeux varié.`,
  ...
  return (
    <>
      <SEOHead
        title={`Avis LunarSpins 2026 : Bonus ${casino.bonusText} | Notre Test Complet`}
        description={`Notre avis complet sur LunarSpins 2026 : bonus ${casino.bonusText}, ${casino.wager === null ? 'sans wager' : `wager x${casino.wager}`}, bookmaker intégré, retraits rapides. Test détaillé !`}
        keywords="casino en ligne, bonus casino, jeux casino, bookmaker, paris sportifs, casino fiable, retraits rapides"
        canonical="https://gigabonus.win/lunarspins"
        ogTitle={`Avis LunarSpins 2026 : Bonus ${casino.bonusText}`}
        ogDescription={`Notre avis complet sur LunarSpins : bonus ${casino.bonusText}, bookmaker, retraits rapides.`}
        ogImage="https://gigabonus.win/images/lunarspins.webp"
        twitterTitle={`Avis LunarSpins 2026 : Bonus ${casino.bonusText}`}
        twitterDescription={`Notre avis complet sur LunarSpins : bonus ${casino.bonusText}, bookmaker, retraits rapides.`}
        schema={schemaData}
      />
      <Navbar />
      <Breadcrumbs />
