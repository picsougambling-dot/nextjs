...
export default function LunarSpinsPage() {
  ...
  return (
    <>
      <SEOHead
        title={`Avis LunarSpins 2025 : Bonus ${casino.bonusText} | Notre Test Complet`}
        description={`Notre avis complet sur LunarSpins 2025 : bonus ${casino.bonusText}, ${casino.wager === null ? 'sans wager' : `wager x${casino.wager}`}, bookmaker intégré, retraits rapides. Test détaillé !`}
        ...
        ogTitle={`Avis LunarSpins 2025 : Bonus ${casino.bonusText}`}
        ...
        twitterTitle={`Avis LunarSpins 2025 : Bonus ${casino.bonusText}`}
