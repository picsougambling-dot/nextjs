...
export default function LibraBetPage() {
  ...
  const schemaData = {
    ...
    "@graph": [
      ...
      {
        "@type": "Article",
        "headline": "LibraBet Casino Avis 2025 : Bonus 100% + 200 FS",
        "author": {
          "@type": "Person",
          "name": "Alexandre Martin"
        },
  ...
  return (
    <>
      <SEOHead
        title="Avis LibraBet Casino 2025 : Bonus 100% jusqu'à 500€ + 200 FS | Notre Test Complet"
        description="Notre avis complet sur LibraBet Casino 2025 : bonus 100% jusqu'à 500€ + 200 free spins, bookmaker intégré, wager x35. Test détaillé !"
        ...
        ogTitle="Avis LibraBet Casino 2025 : Bonus 100% + 200 FS"
        ...
        twitterTitle="Avis LibraBet Casino 2025 : Bonus 100% + 200 FS"
          ...
          <section className="glass-card rounded-3xl overflow-hidden mb-12">
            ...
            <div className="p-8 md:p-12">
              ...
              <h1 className="text-3xl md:text-4xl font-bold text-center text-foreground mb-8">
                Avis LibraBet Casino 2025 : Bonus 100% jusqu'à 500€ + 200 Free Spins - Casino & Bookmaker Complet - Notre Test
              </h1>
