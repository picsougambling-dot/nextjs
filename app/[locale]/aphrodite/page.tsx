...
export default function AphroditePage() {
  ...
  const t = useTranslations('CasinoPages.aphrodite');
  ...
  return (
    <>
      <SEOHead
        title={`Avis Aphrodite Casino 2026 : Bonus ${casino.bonusText} | Notre Test Complet`}
        description={`Notre avis complet sur Aphrodite Casino 2026 : bonus ${casino.bonusText}, ${casino.wager === null ? 'sans wager' : `wager x${casino.wager}`}, bookmaker intégré, retraits rapides. Test détaillé !`}
        ...
        ogTitle={`Avis Aphrodite Casino 2026 : Bonus ${casino.bonusText}`}
        ...
        twitterTitle={`Avis Aphrodite Casino 2026 : Bonus ${casino.bonusText}`}
