...
export default function HiSpinPage() {
  ...
  return (
    <>
      <SEOHead
        title={`Avis HiSpin Casino 2025 : Bonus ${casino.bonusText} | Notre Test Complet`}
        description={`Notre avis complet sur HiSpin Casino 2025 : bonus ${casino.bonusText}, ${casino.wager === null ? 'sans wager' : `wager x${casino.wager}`}, bookmaker intégré, retraits rapides. Test détaillé !`}
        ...
        ogTitle={`Avis HiSpin Casino 2025 : Bonus ${casino.bonusText}`}
        ...
        twitterTitle={`Avis HiSpin Casino 2025 : Bonus ${casino.bonusText}`}
