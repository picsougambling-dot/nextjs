...
export default function SlotsAndCasinoPage() {
  ...
  const t = useTranslations('CasinoPages.slotsandcasino');
  ...
  return (
    <>
      <SEOHead
        title={`Avis SlotsAndCasino 2026 : Bonus ${casino.bonusText} | Notre Test Complet`}
        description={`Notre avis complet sur SlotsAndCasino 2026 : bonus ${casino.bonusText}, ${casino.wager === null ? 'sans wager' : `wager x${casino.wager}`}, retraits rapides. Test détaillé !`}
        ...
        ogTitle={`Avis SlotsAndCasino 2026 : Bonus ${casino.bonusText}`}
        ...
        twitterTitle={`Avis SlotsAndCasino 2026 : Bonus ${casino.bonusText}`}
