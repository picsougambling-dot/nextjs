...
export default function JumbaBetPage() {
  ...
  return (
    <>
      <SEOHead
        title={`Avis JumbaBet Casino 2025 : Bonus ${casino.bonusText} | Notre Test Complet`}
        description={`Notre avis complet sur JumbaBet Casino 2025 : bonus ${casino.bonusText}, ${casino.wager === null ? 'sans wager' : `wager x${casino.wager}`}, retraits rapides. Test détaillé !`}
        ...
        ogTitle={`Avis JumbaBet Casino 2025 : Bonus ${casino.bonusText}`}
        ...
        twitterTitle={`Avis JumbaBet Casino 2025 : Bonus ${casino.bonusText}`}
