...
export default function DepotSkrillPage() {
  const t = useTranslations('DepotPages.skrill');
  ...
  const skrillCasinos = useMemo(() => {
    return casinos.filter((casino) => !casino.hidden && casino.methods.includes("skrill")).sort((a, b) => a.rank - b.rank);
  }, []);
    ...
    "@graph": [
      {
        ...
        "dateModified": "2026-11-28T00:51:35.115Z",
        "author": {
          "@type": "Person",
  ...
  return (
    <>
      <SEOHead
        ...
        canonical={getTranslatedCanonical('/depot/skrill', locale)}
        ogTitle={t('ogTitle')}
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <section className="glass-card rounded-2xl p-8 mb-12 max-w-5xl mx-auto">
            <div className="space-y-4 text-foreground text-center">
              <p className="text-lg leading-relaxed" dangerouslySetInnerHTML={{ __html: getRawTranslation('DepotPages.skrill.intro.p1') }} />
              <p className="text-lg leading-relaxed" dangerouslySetInnerHTML={{ __html: getRawTranslation('DepotPages.skrill.intro.p2') }} />
              <div className="flex flex-wrap justify-center gap-4 mt-6 text-sm">
                ...
                <div className="flex items-center gap-2 bg-primary/10 px-4 py-2 rounded-full">
                  <span className="text-primary font-bold">✓</span>
                  <span>{t('advantages.lowFees')}</span>
                </div>
                <div className="flex items-center gap-2 bg-primary/10 px-4 py-2 rounded-full">
                  <span className="text-primary font-bold">✓</span>
                  <span>{t('advantages.rewards')}</span>
                </div>
                <div className="flex items-center gap-2 bg-primary/10 px-4 py-2 rounded-full">
                  <span className="text-primary font-bold">✓</span>
          ...
          <section className="mt-16 max-w-4xl mx-auto space-y-8">
            <div className="glass-card rounded-2xl p-8">
              ...
              <p className="text-muted-foreground leading-relaxed mb-4" dangerouslySetInnerHTML={{ __html: getRawTranslation('DepotPages.skrill.sections.whatIs.p1') }} />
              <p className="text-muted-foreground leading-relaxed" dangerouslySetInnerHTML={{ __html: getRawTranslation('DepotPages.skrill.sections.whatIs.p2') }} />
            </div>
            ...
            <div className="glass-card rounded-2xl p-8">
              ...
              <p className="text-muted-foreground leading-relaxed mb-4" dangerouslySetInnerHTML={{ __html: getRawTranslation('DepotPages.skrill.sections.vip.p1') }} />
              <p className="text-muted-foreground leading-relaxed" dangerouslySetInnerHTML={{ __html: getRawTranslation('DepotPages.skrill.sections.vip.p2') }} />
            </div>
      ...
      <SEOEnrichedPayment
        ...
        translationNamespace="DepotPages.skrill.seoEnrichedContent"
      />
      <Footer />
    </>
  );
