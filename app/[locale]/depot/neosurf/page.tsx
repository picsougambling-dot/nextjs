...
export default function DepotNeosurfPage() {
  const t = useTranslations('DepotPages.neosurf');
  ...
  const neosurfCasinos = useMemo(() => {
    return casinos.filter((casino) => !casino.hidden && casino.methods.includes("neosurf")).sort((a, b) => a.rank - b.rank);
  }, []);
    ...
    "@graph": [
      {
        ...
        "dateModified": "2026-11-28T00:51:35.111Z",
        "author": {
          "@type": "Person",
  ...
  return (
    <>
      <SEOHead
        ...
        canonical={getTranslatedCanonical('/depot/neosurf', locale)}
        ogTitle={t('ogTitle')}
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <section className="glass-card rounded-2xl p-8 mb-12 max-w-5xl mx-auto">
            <div className="space-y-4 text-foreground text-center">
              <p className="text-lg leading-relaxed" dangerouslySetInnerHTML={{ __html: getRawTranslation('DepotPages.neosurf.intro.p1') }} />
              <p className="text-lg leading-relaxed" dangerouslySetInnerHTML={{ __html: getRawTranslation('DepotPages.neosurf.intro.p2') }} />
          ...
          <section className="mt-16 max-w-4xl mx-auto space-y-8">
            <div className="glass-card rounded-2xl p-8">
              ...
              <p className="text-muted-foreground leading-relaxed mb-4" dangerouslySetInnerHTML={{ __html: getRawTranslation('DepotPages.neosurf.sections.whatIs.p1') }} />
              <p className="text-muted-foreground leading-relaxed" dangerouslySetInnerHTML={{ __html: getRawTranslation('DepotPages.neosurf.sections.whatIs.p2') }} />
            </div>
      ...
      <SEOEnrichedPayment
        ...
        translationNamespace="DepotPages.neosurf.seoEnrichedContent"
      />
      <Footer />
    </>
  );
