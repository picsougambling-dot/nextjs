...
export default function DepotCashlibPage() {
  const t = useTranslations('DepotPages.cashlib');
  ...
  const cashlibCasinos = useMemo(() => {
    return casinos.filter((casino) => !casino.hidden && casino.methods.includes("cashlib")).sort((a, b) => a.rank - b.rank);
  }, []);
  ...
  }, [cashlibCasinos, searchTerm, bonusFilter, wagerFilter, userCountry]);
    ...
    "@graph": [
      {
        ...
        "dateModified": "2026-11-28T00:51:35.112Z",
        "author": {
          "@type": "Person",
  ...
  return (
    <>
      <SEOHead
        ...
        canonical={getTranslatedCanonical('/depot/cashlib', locale)}
        ogTitle={t('ogTitle')}
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <section className="glass-card rounded-2xl p-8 mb-12 max-w-5xl mx-auto">
            <div className="space-y-4 text-foreground text-center">
              <p className="text-lg leading-relaxed" dangerouslySetInnerHTML={{ __html: getRawTranslation('DepotPages.cashlib.intro.p1') }} />
              <p className="text-lg leading-relaxed" dangerouslySetInnerHTML={{ __html: getRawTranslation('DepotPages.cashlib.intro.p2') }} />
              <div className="flex flex-wrap justify-center gap-4 mt-6 text-sm">
                <div className="flex items-center gap-2 bg-primary/10 px-4 py-2 rounded-full">
                  <span className="text-primary font-bold">✓</span>
                  <span>{t('advantages.anonymous')}</span>
                </div>
                <div className="flex items-center gap-2 bg-primary/10 px-4 py-2 rounded-full">
                  <span className="text-primary font-bold">✓</span>
                  <span>{t('advantages.instant')}</span>
                </div>
                <div className="flex items-center gap-2 bg-primary/10 px-4 py-2 rounded-full">
                  <span className="text-primary font-bold">✓</span>
                  <span>{t('advantages.noCard')}</span>
                </div>
                <div className="flex items-center gap-2 bg-primary/10 px-4 py-2 rounded-full">
                  <span className="text-primary font-bold">✓</span>
                  <span>{t('advantages.budgetControl')}</span>
                </div>
              </div>
            </div>
          </section>
          ...
          <section className="mt-16 max-w-4xl mx-auto space-y-8">
            <div className="glass-card rounded-2xl p-8">
              ...
              <p className="text-muted-foreground leading-relaxed mb-4" dangerouslySetInnerHTML={{ __html: getRawTranslation('DepotPages.cashlib.sections.whatIs.p1') }} />
              <p className="text-muted-foreground leading-relaxed" dangerouslySetInnerHTML={{ __html: getRawTranslation('DepotPages.cashlib.sections.whatIs.p2') }} />
            </div>
            ...
            <div className="glass-card rounded-2xl p-8">
              ...
              <div className="space-y-3 text-muted-foreground">
                <p className="flex items-start gap-2">
                  <span className="text-primary font-bold">✓</span>
                  <span dangerouslySetInnerHTML={{ __html: t('sections.whyChoose.anonymity') }} />
                </p>
                <p className="flex items-start gap-2">
                  <span className="text-primary font-bold">✓</span>
                  <span dangerouslySetInnerHTML={{ __html: t('sections.whyChoose.budgetControl') }} />
                </p>
                <p className="flex items-start gap-2">
                  <span className="text-primary font-bold">✓</span>
                  <span dangerouslySetInnerHTML={{ __html: t('sections.whyChoose.noAccount') }} />
                </p>
                <p className="flex items-start gap-2">
                  <span className="text-primary font-bold">✓</span>
                  <span dangerouslySetInnerHTML={{ __html: t('sections.whyChoose.availableEverywhere') }} />
                </p>
              </div>
            </div>
            ...
            <div className="glass-card rounded-2xl p-8">
              ...
              <p className="text-muted-foreground leading-relaxed mb-4" dangerouslySetInnerHTML={{ __html: getRawTranslation('DepotPages.cashlib.sections.security.p1') }} />
              <p className="text-muted-foreground leading-relaxed" dangerouslySetInnerHTML={{ __html: getRawTranslation('DepotPages.cashlib.sections.security.p2') }} />
            </div>
      ...
      <SEOEnrichedPayment
        ...
        translationNamespace="DepotPages.cashlib.seoEnrichedContent"
      />
      <Footer />
    </>
  );
