...
export default function SlotsOfVegasPage() {
  ...
  return (
    <>
      <SEOHead
        title={`Avis Slots Of Vegas Casino 2025 : Bonus ${casino.bonusText} | Notre Test Complet`}
        description={`Notre avis complet sur Slots Of Vegas Casino 2025 : bonus ${casino.bonusText}, ${casino.wager === null ? 'sans wager' : `wager x${casino.wager}`}, retraits rapides. Test détaillé !`}
        ...
        ogTitle={`Avis Slots Of Vegas Casino 2025 : Bonus ${casino.bonusText}`}
        ...
        twitterTitle={`Avis Slots Of Vegas Casino 2025 : Bonus ${casino.bonusText}`}
