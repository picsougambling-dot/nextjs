...
export default function BigDollarPage() {
  const videoRef = useRef<HTMLVideoElement>(null);
  const tCommon = useTranslations('Common');
  const locale = useLocale();
  const t = useTranslations('CasinoPages.bigdollar');
  const casino = casinos.find(c => c.name === "Big Dollar")!;
    ...
    "@graph": [
      {
        ...
        "itemReviewed": {
          ...
          "image": "https://gigabonus.win/images/bigdollar.webp"
        },
        "author": {
          "@type": "Person",
        ...
        "reviewBody": `Big Dollar Casino propose un bonus de ${casino.bonusText} avec ${casino.wager === null ? 'sans conditions de mise' : `wager x${casino.wager}`}. Plateforme complète avec catalogue de jeux varié.`,
  ...
  return (
    <>
      <SEOHead
        title={`Avis Big Dollar Casino 2026 : Bonus ${casino.bonusText} | Notre Test Complet`}
        description={`Notre avis complet sur Big Dollar Casino 2026 : bonus ${casino.bonusText}, ${casino.wager === null ? 'sans wager' : `wager x${casino.wager}`}, retraits rapides. Test détaillé !`}
        keywords="casino en ligne, bonus casino, jeux casino, casino fiable, retraits rapides, casino US"
        canonical="https://gigabonus.win/bigdollar"
        ogTitle={`Avis Big Dollar Casino 2026 : Bonus ${casino.bonusText}`}
        ogDescription={`Notre avis complet sur Big Dollar Casino : bonus ${casino.bonusText}, retraits rapides.`}
        ogImage="https://gigabonus.win/images/bigdollar.webp"
        twitterTitle={`Avis Big Dollar Casino 2026 : Bonus ${casino.bonusText}`}
        twitterDescription={`Notre avis complet sur Big Dollar Casino : bonus ${casino.bonusText}, retraits rapides.`}
        schema={schemaData}
      />
      <Navbar />
      <Breadcrumbs />
