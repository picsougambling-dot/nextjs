...
export default function BigDollarPage() {
  ...
  return (
    <>
      <SEOHead
        title={`Avis Big Dollar Casino 2025 : Bonus ${casino.bonusText} | Notre Test Complet`}
        description={`Notre avis complet sur Big Dollar Casino 2025 : bonus ${casino.bonusText}, ${casino.wager === null ? 'sans wager' : `wager x${casino.wager}`}, retraits rapides. Test détaillé !`}
        ...
        ogTitle={`Avis Big Dollar Casino 2025 : Bonus ${casino.bonusText}`}
        ...
        twitterTitle={`Avis Big Dollar Casino 2025 : Bonus ${casino.bonusText}`}
