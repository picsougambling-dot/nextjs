...
export default function SpinnyCasinoPage() {
  ...
  return (
    <>
      <SEOHead
        title={`Avis SpinnyCasino 2025 : Bonus ${casino.bonusText} | Notre Test Complet`}
        description={`Notre avis complet sur SpinnyCasino 2025 : bonus ${casino.bonusText}, ${casino.wager === null ? 'sans wager' : `wager x${casino.wager}`}, bookmaker intégré, retraits rapides. Test détaillé !`}
        ...
        ogTitle={`Avis SpinnyCasino 2025 : Bonus ${casino.bonusText}`}
        ...
        twitterTitle={`Avis SpinnyCasino 2025 : Bonus ${casino.bonusText}`}
