          ...
          <section className="glass-card rounded-2xl p-8 mb-12 max-w-5xl mx-auto">
            <div className="space-y-4 text-foreground text-center">
              <p className="text-lg leading-relaxed">
                ...
                Sur <strong className="text-primary">GigaBonus.win</strong>, découvrez notre sélection de <strong className="text-primary">casinos sans vérification d&apos;identité</strong> permettant de jouer et retirer anonymement jusqu&apos;à 5000€ sans fournir de documents.
              </p>
              <p className="text-lg leading-relaxed">
