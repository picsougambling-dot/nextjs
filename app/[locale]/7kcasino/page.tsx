...
export default function SevenKCasinoPage() {
  ...
  const t = useTranslations('CasinoPages.7kcasino');
  ...
  return (
    <>
      <SEOHead
        title={`Avis 7k.Casino 2026 : Bonus ${casino.bonusText} | Notre Test Complet`}
        description={`Notre avis complet sur 7k.Casino 2026 : bonus ${casino.bonusText}, ${casino.wager === null ? 'sans wager' : `wager x${casino.wager}`}, bookmaker intégré, retraits rapides. Test détaillé !`}
        ...
        ogTitle={`Avis 7k.Casino 2026 : Bonus ${casino.bonusText}`}
        ...
        twitterTitle={`Avis 7k.Casino 2026 : Bonus ${casino.bonusText}`}
