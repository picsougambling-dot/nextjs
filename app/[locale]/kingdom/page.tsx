    ...
    "@graph": [
      {
        ...
        "reviewBody": `Kingdom Casino propose un bonus de ${casino.bonusText} avec ${casino.wager === null ? 'sans conditions de mise' : `wager x${casino.wager}`}. Plateforme complète avec catalogue de jeux varié.`,
  ...
  return (
    <>
      <SEOHead
        ...
        twitterTitle={`Avis Kingdom Casino 2026 : Bonus ${casino.bonusText}`}
              ...
              <div className="text-center mb-8">
                ...
                <div className="space-y-4 text-foreground max-w-4xl mx-auto">
                  ...
                  <p>
                    ...
                    <strong className="text-primary"> wager de x{casino.wager}</strong>, particulièrement compétitif. 
            ...
            <div className="grid md:grid-cols-2 gap-6 max-w-5xl mx-auto mb-8">
              <div className="glass-card rounded-xl p-6">
                ...
                <ul className="space-y-2">
                  ...
                  <li className="text-foreground flex items-start gap-2">
                    <CheckCircle2 className="w-4 h-4 text-green-500 flex-shrink-0 mt-1" />
                    <span>Wager x{casino.wager} compétitif</span>
                  </li>
                  <li className="text-foreground flex items-start gap-2">
                    <CheckCircle2 className="w-4 h-4 text-green-500 flex-shrink-0 mt-1" />
