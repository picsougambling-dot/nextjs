...
export default function Bets31Page() {
  ...
  return (
    <>
      <SEOHead
        title={`Avis 31Bets Casino 2025 : Bonus ${casino.bonusText} | Notre Test Complet`}
        description={`Notre avis complet sur 31Bets Casino 2025 : bonus ${casino.bonusText}, ${casino.wager === null ? 'sans wager' : `wager x${casino.wager}`}, bookmaker intégré, retraits rapides. Test détaillé !`}
        ...
        ogTitle={`Avis 31Bets Casino 2025 : Bonus ${casino.bonusText}`}
        ...
        twitterTitle={`Avis 31Bets Casino 2025 : Bonus ${casino.bonusText}`}
