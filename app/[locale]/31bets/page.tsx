...
export default function Bets31Page() {
  const videoRef = useRef<HTMLVideoElement>(null);
  const tCommon = useTranslations('Common');
  const locale = useLocale();
  const t = useTranslations('CasinoPages.31bets');
  const casino = casinos.find(c => c.name === "31Bets")!;
    ...
    "@graph": [
      {
        ...
        "itemReviewed": {
          "@type": "Product",
          "name": "31Bets Casino",
          "image": "https://gigabonus.win/images/31bets.webp"
        },
        "author": {
          "@type": "Person",
        ...
        "reviewBody": `31Bets Casino propose un bonus de ${casino.bonusText} avec ${casino.wager === null ? 'sans conditions de mise' : `wager x${casino.wager}`}. Plateforme complète avec bookmaker intégré et catalogue de jeux varié.`,
  ...
  return (
    <>
      <SEOHead
        title={`Avis 31Bets Casino 2026 : Bonus ${casino.bonusText} | Notre Test Complet`}
        description={`Notre avis complet sur 31Bets Casino 2026 : bonus ${casino.bonusText}, ${casino.wager === null ? 'sans wager' : `wager x${casino.wager}`}, bookmaker intégré, retraits rapides. Test détaillé !`}
        keywords="casino en ligne, bonus casino, jeux casino, bookmaker, paris sportifs, casino fiable, retraits rapides"
        canonical="https://gigabonus.win/31bets"
        ogTitle={`Avis 31Bets Casino 2026 : Bonus ${casino.bonusText}`}
        ogDescription={`Notre avis complet sur 31Bets Casino : bonus ${casino.bonusText}, bookmaker, retraits rapides.`}
        ogImage="https://gigabonus.win/images/31bets.webp"
        twitterTitle={`Avis 31Bets Casino 2026 : Bonus ${casino.bonusText}`}
        twitterDescription={`Notre avis complet sur 31Bets Casino : bonus ${casino.bonusText}, bookmaker, retraits rapides.`}
        schema={schemaData}
      />
      <Navbar />
      <Breadcrumbs />
              ...
              <div className="text-center mb-8">
                ...
                <div className="space-y-4 text-foreground max-w-4xl mx-auto">
                  ...
                  <p>
                    ...
                    <strong className="text-primary"> catalogue de jeux varié</strong> avec plus de 90 fournisseurs de jeux. 
                    Les méthodes de paiement incluent <strong className="text-primary">virements bancaires et cryptomonnaies</strong>.
                  </p>
                  <p>
            ...
            <div className="grid md:grid-cols-2 gap-6 max-w-5xl mx-auto mb-8">
              <div className="glass-card rounded-xl p-6">
                ...
                <ul className="space-y-2">
                  ...
                  <li className="text-foreground flex items-start gap-2">
                    <CheckCircle2 className="w-4 h-4 text-green-500 flex-shrink-0 mt-1" />
                    <span>Catalogue exceptionnel avec plus de 90 fournisseurs</span>
                  </li>
                </ul>
              </div>
              ...
              <div className="glass-card rounded-xl p-6">
                ...
                <ul className="space-y-2">
                  ...
                  <li className="text-foreground flex items-start gap-2">
                    <span className="w-4 h-4 flex items-center justify-center text-orange-500 flex-shrink-0 mt-1">•</span>
                    <span>Disponible uniquement au Royaume-Uni, Canada et Australie</span>
                  </li>
                </ul>
              </div>
            </div>
