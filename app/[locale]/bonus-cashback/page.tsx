...
import { TrendingDown, Gift, Copy, Check, Sparkles, Shield, Zap, Coins } from "lucide-react";
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <section className="mt-16 max-w-4xl mx-auto space-y-8">
            ...
            <div className="glass-card rounded-2xl p-8 bg-gradient-to-r from-primary/5 to-accent/5">
              <h2 className="text-3xl font-bold mb-6 text-foreground">💰 Casinos recommandés avec bonus cashback avantageux</h2>
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4 mb-8">
                <Link href={`/${locale}/rockstar`} className="block p-4 border rounded-lg hover:border-primary transition-colors bg-card">
                ...
                <Link href={`/${locale}/luckytrunk`} className="block p-4 border rounded-lg hover:border-primary transition-colors bg-card">
                  <div className="flex items-center gap-2 mb-2">
                    <Coins className="w-5 h-5 text-green-500" />
                ...
                <Link href={`/${locale}/wilddice`} className="block p-4 border rounded-lg hover:border-primary transition-colors bg-card">
                  <div className="flex items-center gap-2 mb-2">
                    <Coins className="w-5 h-5 text-green-500" />
                ...
                <Link href={`/${locale}/amonbet`} className="block p-4 border rounded-lg hover:border-primary transition-colors bg-card">
                  <div className="flex items-center gap-2 mb-2">
                    <Coins className="w-5 h-5 text-green-500" />
                ...
                <Link href={`/${locale}/slotlair`} className="block p-4 border rounded-lg hover:border-primary transition-colors bg-card">
                  <div className="flex items-center gap-2 mb-2">
                    <Coins className="w-5 h-5 text-green-500" />
