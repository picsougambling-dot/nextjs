...
export default function OrionsBetPage() {
  ...
  return (
    <>
      <SEOHead
        title={`Avis OrionsBet Casino 2025 : Bonus ${casino.bonusText} | Notre Test Complet`}
        description={`Notre avis complet sur OrionsBet Casino 2025 : bonus ${casino.bonusText}, ${casino.wager === null ? 'sans wager' : `wager x${casino.wager}`}, bookmaker intégré, retraits rapides. Test détaillé !`}
        ...
        ogTitle={`Avis OrionsBet Casino 2025 : Bonus ${casino.bonusText}`}
        ...
        twitterTitle={`Avis OrionsBet Casino 2025 : Bonus ${casino.bonusText}`}
