...
export default function OnlySpinsPage() {
  const videoRef = useRef<HTMLVideoElement>(null);
  const tCommon = useTranslations('Common');
  const locale = useLocale();
  const t = useTranslations('CasinoPages.onlyspins');
  const casino = casinos.find(c => c.name === "OnlySpins")!;
    ...
    "@graph": [
      {
        ...
        "itemReviewed": {
          ...
          "image": "https://gigabonus.win/images/onlyspins.webp"
        },
        "author": {
          "@type": "Person",
        ...
        "reviewBody": "OnlySpins Casino offre un bonus généreux de 100% jusqu'à 500€ avec 200 free spins. Le casino propose également un bookmaker intégré et une large sélection de fournisseurs de jeux. Wager x35 et méthodes de paiement variées.",
        "datePublished": "2026-01-10T10:00:00Z",
        "dateModified": new Date().toISOString()
      },
      {
        "@type": "Article",
        "headline": "OnlySpins Casino Avis 2026 : Bonus 100% + 200 FS",
        "author": {
          "@type": "Person",
          "name": "Alexandre Martin"
        },
      ...
      },
      {
        ...
        "mainEntity": [
          {
            "@type": "Question",
            "name": "Quel est le bonus de bienvenue d'OnlySpins ?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "OnlySpins offre un bonus de 100% jusqu'à 500€ plus 200 free spins pour votre premier dépôt. Le wager est de x35."
            }
          },
          {
            "@type": "Question",
            "name": "OnlySpins a-t-il un bookmaker ?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Oui, OnlySpins propose un bookmaker intégré pour les paris sportifs en plus des jeux de casino."
            }
          }
        ]
      }
  ...
  return (
    <>
      <SEOHead
        title="Avis OnlySpins Casino 2026 : Bonus 100% jusqu'à 500€ + 200 FS | Notre Test Complet"
        description="Notre avis complet sur OnlySpins Casino 2026 : bonus 100% jusqu'à 500€ + 200 free spins, bookmaker intégré, wager x35. Test détaillé !"
        keywords="onlyspins casino, avis onlyspins, bonus casino, bookmaker, free spins, onlyspins avis"
        canonical="https://gigabonus.win/onlyspins"
        ogTitle="Avis OnlySpins Casino 2026 : Bonus 100% + 200 FS"
        ogDescription="Notre avis complet sur OnlySpins Casino : bonus 100% jusqu'à 500€, 200 free spins, bookmaker intégré."
        ogImage="https://gigabonus.win/images/onlyspins.webp"
        twitterTitle="Avis OnlySpins Casino 2026 : Bonus 100% + 200 FS"
        twitterDescription="Notre avis complet sur OnlySpins Casino : bonus généreux, free spins, bookmaker."
        schema={schemaData}
      />
      <Navbar />
      <Breadcrumbs />
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <section className="glass-card rounded-3xl overflow-hidden mb-12">
            ...
            <div className="p-8 md:p-12">
              ...
              <h1 className="text-3xl md:text-4xl font-bold text-center text-foreground mb-8">
                Avis OnlySpins Casino 2026 : Bonus 100% jusqu'à 500€ + 200 Free Spins - Casino & Bookmaker Complet - Notre Test
              </h1>

              <div className="text-center mb-8">
                <h2 className="text-3xl font-bold text-primary mb-6">À Propos d'OnlySpins Casino</h2>
                <div className="space-y-4 text-foreground max-w-4xl mx-auto">
                  <p>
                    <strong className="text-primary">OnlySpins Casino</strong> se distingue par son <strong className="text-primary">bonus de bienvenue généreux</strong> de 100% jusqu'à 500€ accompagné de <strong className="text-primary">200 free spins</strong>. 
                    Avec un <strong className="text-primary">wager de x35</strong>, OnlySpins offre des conditions équilibrées pour les joueurs français. 
                  ...
                  <p>
                    L'<strong className="text-primary">interface moderne et intuitive</strong> d'OnlySpins facilite la navigation entre les différents types de jeux. 
                  ...
                  <p>
                    ...
                    OnlySpins opère sous licence et respecte toutes les normes de jeu responsable. Le dépôt minimum de 20€ rend le casino
                  ...
                  <p>
                    ...
                    OnlySpins combine ainsi le meilleur des deux mondes : casino et paris sportifs sur une seule plateforme.
                  </p>
                </div>
                <Button
                  asChild
          ...
          <section className="mb-12">
            <h2 className="text-4xl font-bold text-center text-foreground mb-8">
              🎁 {tCommon('sections.offersAndPromotions')} OnlySpins
            </h2>
          ...
          <section className="glass-card rounded-2xl p-8 mb-12">
            <h2 className="text-3xl font-bold text-center text-foreground mb-6">📝 {tCommon('sections.howToRegister')} sur OnlySpins Casino ?</h2>
            <div className="space-y-6 text-foreground max-w-4xl mx-auto">
              <p className="leading-relaxed">
                L'<strong className="text-primary">inscription sur OnlySpins</strong> est simple et rapide. 
              ...
              <div className="glass-card rounded-xl p-6">
                ...
                <p className="leading-relaxed">
                  OnlySpins vous envoie un <strong className="text-primary">email de confirmation</strong>. Cliquez sur le lien pour activer votre compte. 
              ...
              <div className="glass-card rounded-xl p-6">
                ...
                <p className="leading-relaxed">
                  ...
                  (carte bancaire, Paysafecard, Skrill, Neteller, ou virement). Le <strong className="text-primary">dépôt minimum est de 20€</strong>. 
          ...
          {/* FAQ Complète */}
          <section className="glass-card rounded-2xl p-8 mb-12">
            <h2 className="text-3xl font-bold text-center text-foreground mb-8">❓ Questions Fréquentes sur OnlySpins Casino</h2>
            
            <div className="space-y-6 max-w-4xl mx-auto">
              <div className="glass-card rounded-xl p-6">
                <h3 className="text-xl font-semibold text-primary mb-3">Quel est le bonus de bienvenue d'OnlySpins ?</h3>
                <p className="text-foreground leading-relaxed">
                  OnlySpins offre un <strong className="text-primary">bonus de 100% jusqu'à 500€</strong> plus <strong className="text-primary">200 free spins</strong> 
                  pour votre premier dépôt. Le wager est de x35, ce qui est une condition équitable dans l'industrie.
                </p>
              </div>

              <div className="glass-card rounded-xl p-6">
                <h3 className="text-xl font-semibold text-primary mb-3">OnlySpins a-t-il un bookmaker ?</h3>
                <p className="text-foreground leading-relaxed">
                  Oui, OnlySpins propose un <strong className="text-primary">bookmaker intégré</strong> pour les paris sportifs. 
              ...
              <div className="glass-card rounded-xl p-6">
                ...
                <p className="text-foreground leading-relaxed">
                  OnlySpins accepte les <strong className="text-primary">cartes bancaires</strong>, <strong className="text-primary">Paysafecard</strong>, 
                  <strong className="text-primary"> Skrill</strong>, <strong className="text-primary">Neteller</strong>, et les <strong className="text-primary">virements bancaires</strong>. 
              ...
              <div className="glass-card rounded-xl p-6">
                ...
                <p className="text-foreground leading-relaxed">
                  OnlySpins propose plus de <strong className="text-primary">70 fournisseurs</strong> incluant Play'n GO, NetEnt, Evolution Gaming, 
                  Pragmatic Play, Hacksaw Gaming, NoLimit City, Yggdrasil, et bien d'autres. La ludothèque compte plus de 5000 jeux.
                </p>
              </div>

              <div className="glass-card rounded-xl p-6">
                <h3 className="text-xl font-semibold text-primary mb-3">OnlySpins est-il disponible en France ?</h3>
                <p className="text-foreground leading-relaxed">
                  Oui, OnlySpins est <strong className="text-primary">disponible pour les joueurs français</strong>. 
          ...
          <section className="text-center glass-card rounded-2xl p-12 bg-gradient-to-br from-primary/20 to-secondary/20">
            <h2 className="text-3xl font-bold mb-4 text-foreground">Rejoignez OnlySpins Casino</h2>
            ...
            >
              <a href={casino.playUrl} target="_blank" rel="noopener noreferrer">
                <ExternalLink className="w-6 h-6 mr-2" />
                Jouer sur OnlySpins Maintenant
              </a>
            </Button>
          </section>
        </div>
      ...
      <SEOEnrichedContent
        ...
        rating={8.5}
        reviewsCount={2500}
        competitors={["HunnyPlay", "Kings Chance", "Lucky Treasure"]}
        slug="onlyspins"
      />
