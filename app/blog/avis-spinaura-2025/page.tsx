      ...
      <div className="min-h-screen pt-28 pb-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-5xl mx-auto">
          ...
          <RelatedLinks 
            ...
            links={[
              {title: "Page SpinAura", description: "Découvrez toutes les offres", href: "/spinaura"}, 
              {title: "Top Slots 2025", description: "Les meilleures machines à sous", href: "/top-slots-2025"},
              {title: "Dépôt Crypto", description: "Casinos acceptant les cryptomonnaies", href: "/depot/crypto"}
            ]} 
          />
        </div>
      </div>
