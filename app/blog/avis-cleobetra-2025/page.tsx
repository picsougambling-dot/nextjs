    ...
    <>
      ...
      <div className="min-h-screen pt-28 pb-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-5xl mx-auto">
          ...
          <RelatedLinks 
            links={[
              { href: "/blog", title: "Retour au Blog", description: "Découvrez tous nos avis et guides casino" },
              { href: "/", title: "Tous les Casinos", description: "Comparez les meilleurs casinos en ligne" },
              { href: "/bonus-cashback", title: "Bonus Cashback", description: "Récupérez vos pertes chaque semaine" }
            ]}
          />
        </div>
      </div>
