    ...
    <>
      ...
      <div className="min-h-screen pt-28 pb-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-5xl mx-auto">
          ...
          <RelatedLinks 
            links={[
              { href: "/blog", title: "Retour au Blog", description: "Tous nos avis" },
              { href: "/", title: "Casinos", description: "Comparez" },
              { href: "/bonus-cashback", title: "Cashback", description: "20% de retour" }
            ]}
          />
